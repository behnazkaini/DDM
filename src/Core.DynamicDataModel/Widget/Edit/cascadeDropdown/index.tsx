...
function CascadeDropdownWidget(props: ComponentProps<AggregationOneToOneValue> & { referenceDataModelGuid: string; CascadeDropDownLevel: number, Widget: WidgetType }) {
