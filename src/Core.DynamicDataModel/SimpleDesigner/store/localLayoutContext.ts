...
export enum SubLayoutActionType {
    ...
    SET_RELATIONTYPE = 'SET_RELATIONTYPE',
    SET_SUBLAYOUTGUID = 'SET_SUBLAYOUTGUID'
}
...
export function SubLayoutRelationReducer(
    ...
    switch (action.type as SubLayoutActionType) {
        ...
        case SubLayoutActionType.SET_RELATIONTYPE:
            return { ...state, relationType: action.payload.relationType};
        case SubLayoutActionType.SET_SUBLAYOUTGUID:
            return { ...state, SubLayoutGuid: action.payload.SubLayoutGuid};
        default:
            throw new Error();
    }
}