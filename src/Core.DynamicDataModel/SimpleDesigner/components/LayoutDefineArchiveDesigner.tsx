...
interface LayoutDefineArchiveDesignerProps {}

const LayoutDefineArchiveDesigner = (
  props: LayoutDefineArchiveDesignerProps
) => {
  const { layoutGuid, mode, permission } = React.useContext(SimpleDesignerGlobalPropsContext);
...
export default LayoutDefineArchiveDesigner;
