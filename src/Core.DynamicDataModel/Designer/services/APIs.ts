...
export default class DDM_API {
  ...
  SaveVariables(Request: SaveDataModelVariableViewModel): DidgahDeferred<boolean> {
    let deferred = DidgahDeferred.create();
    this.ajax
      .post({
        url: this.APIUrl + "DataModel/SaveVariables",
        data: { ...Request },
      })
      .done((data) => {
        deferred.resolve(data);
  ...
  CopyLayout(Request: any): DidgahDeferred<boolean> {
    let deferred = DidgahDeferred.create();
    this.ajax
      .post({
        url: this.APIUrl + "Layout/CopyLayout",
        data: { ...Request },
      })
      .done((data) => {
        deferred.resolve(data);
