...
import { Alert, Button, CheckboxItem, CheckboxList, Form, Input, Label, Modal, StackPanel, WrappedFormUtils } from "didgah/ant-core-component";
import { CheckboxListStore } from "didgah/ant-core-component/providers";
import { translate } from "../../../../../Utility/language";
import { IDictionary, ReferenceRadioButton } from "../../../../../typings/Core.DynamicDataModel/Types";
...
interface WrapperInputProps {
  ...
  value?: ReferenceRadioButton["ReferenceRadioButtonColumnsConfig"];
  onChange?: (value: ReferenceRadioButton["ReferenceRadioButtonColumnsConfig"]) => void;
...
const WrapperInput: FC<WrapperInputProps> = ({ columns, value, onChange, form, settingName, onSave, dataModelLabel }) => {
  ...
  const settingSaveDataFactory = (): ReferenceRadioButton["ReferenceRadioButtonColumnsConfig"] => {
  ...
  return (
    <>
      ...
      >
        ...
        <Form>
          <Form.Row>
            <Form.Item label={translate("SeperableCharacter")} labelCol={{ span: 6 }} wrapperCol={{ span: 18 }}>
              <Input
                maxLength={1}
