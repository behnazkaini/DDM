...
import { ReferenceRadioButton, RichLayoutItem, SettingFormItemProps } from "../../../../../typings/Core.DynamicDataModel/Types";
...
const ReferenceRadioButtonColumns: FC<
  SettingFormItemProps<ReferenceRadioButton> & {
  ...
  return (
    <Spin spinning={loading} stretch>
      <Form.Item wrapperCol={{ span: 24 }}>
        {form.getFieldDecorator(settingName, { initialValue: initialSettingValues.ReferenceRadioButtonColumnsConfig })(
          <WrapperInput
...
export default ReferenceRadioButtonColumns;
