...
interface IntegerRangeSettingProps {
...
const IntegerRangeSetting = (props: IntegerRangeSettingProps) => {
  const { initialValue, form, errorCallback } = props;
  const { Min, Max } = initialValue;
  const maxIntNumber = 2147483647;
  const minIntNumber = -2147483649;
...
export default IntegerRangeSetting;
